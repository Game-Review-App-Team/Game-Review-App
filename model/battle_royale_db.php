...
App Name: Game Rating App
    ...
    This is the battle_royale database connection file. 
...
class Battle_RoyaleDB {
    ...
    public static function getReviews() {
        ...
        if ($dbConn) {
            ...
            $query = 'SELECT * FROM battle_royales';
    ...
    public static function getReviewsByReview($reviewId) {
        ...
        if ($dbConn) {
            //create the query string
            $query = "SELECT * FROM battle_royales
                    WHERE battle_royales.ReviewId = '$reviewId'";
    ...
    public static function deleteReview($reviewId) {
        ...
        if ($dbConn) {
            //create the query string
            $query = "DELETE FROM battle_royales
                    WHERE ReviewId = '$reviewId'";
        ...
        $reviewPostDate)
    {
        ...
        if ($dbConn) {
            ...
            //specify it
            $query =
            "INSERT INTO battle_royales (EMail,
